 ...
 */
registerRoute(
  ({ url }) => url.origin === 'https://petstore3.swagger.io' && url.pathname.startsWith('/api/v3/'),
  new StaleWhileRevalidate({
    cacheName: 'petstore-api-response',
    plugins: [
      new CacheableResponsePlugin({
        statuses: [0, 200],
      }),
...
registerRoute(
  ({ url }) => url.origin === 'https://6335724eea0de5318a13ad6d.mockapi.io',
  new StaleWhileRevalidate({
    cacheName: 'mockapi-api-response',
    plugins: [
      new CacheableResponsePlugin({
        statuses: [0, 200],
      }),
